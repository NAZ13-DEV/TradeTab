...
import FundNow from '../../../components/deposit/fundnow';
import CopyWallet from '../../../components/deposit/copywallet';
import UploadProof from '../../../components/deposit/confirm_deposit';
  ...
  return (
    <div className='bg-Primary-3 p-4 lg:p-5 xl-7 rounded-xl col-span-12 xl:col-span-4 w-[full]'>
      <div className='mt-6 gap-6 grid grid-cols-12'>
        ...
        {currentState === 'UploadProof' && <UploadProof
        isLoading={isLoading}
        setIsLoading={setIsLoading}
        />}
      </div>
