      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive">
            <h5 class="card-title">Everthing About Kyc</h5>
...
<div class="form-group">
  ...
  <input type="hidden" class="form-control" id="tradeidForLoss" name="tradeidForLoss" value="">
</div>
</div>
...
<div class="form-group">
  ...
  <input type="hidden" class="form-control" id="tradeproId" name="tradeproId" value="">
</div>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-secondary"
...
<button  type="submit" class="btn btn-primary" id="sendMessage">Send message</button>
  ...
  <script src="jsFiles/viewTrade.js"></script>
<script>
