...
class WithdrawalGateway
{
    ...
    public function swap(array $swap)
    {
        foreach ($swap as $key => $value) {
            ...
            $swapcolumn = ["fromvalue", "tovalue", "amount", "userId", "transId", "transStatus", "dateOfTrans","drfgfgh"];
...
$toValue = (float)$userFetchDetailsWithId[$sto];
    ...
    public function copyTrade(array $swap)
    {
        foreach ($swap as $key => $value) {
            ...
            $swapcolumn = ["traderName", "winRate", "abbr", "userId", "transId", "transStatus", "dateOfTrans"];
    ...
    {
        // try {
            $CryptoWithdrawalcolumn = ["userId", "payment_mode", "amount", "wallet", "transId", "transStatus", "dateOfTrans"];
    ...
    public function bankWithdrawal(array $bankWithdrawaldata)
    {
        // var_dump($bankWithdrawaldata);
            ...
            if ($result === true || $result === null) {
                ...
                $bankWithdrawaldata['dateOfTrans'] = date('d-m-Y h:i:s a', time());
