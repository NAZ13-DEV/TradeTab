...
function populateStates(countryElementClass, stateElementClass) {
  var selectedCountryIndex = document.querySelector(
    "." + countryElementClass
  ).selectedIndex;

  var stateElement = document.querySelector("." + stateElementClass);
...
function populateCountries(countryElementClass, stateElementClass) {
  // given the class name of the <select> tag as function argument, it inserts <option> tags
  var countryElement = document.querySelector("." + countryElementClass);
  ...
  if (stateElementClass) {
    countryElement.onchange = function () {
      populateStates(countryElementClass, stateElementClass);
    };
  }
}
