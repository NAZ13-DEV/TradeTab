      ...
      <div class="card box1 shadow-sm p-md-5 p-md-5 p-4" id="close">
        ...
        <div class="d-flex flex-column">
          ...
          <div class="containerr">
            ...
            <div class="d-flex flex-column align-items-start mb-4 scroll">

              <div class="d-flex align-items-center">
                <img class="qr-code" id="qrcode"
                  src="https://quickchart.io/qr?text=bc1qe6l29egtfs9kum3utygmew5n7quzngfcph4706" />
                <div class="ps-3 truncate-address">
                  <span class="add" id="waallet">bc1qe6l29egtfs9kum3utygmew5n7quzngfcph4706</span> <i class="bi bi-qr-code" id="qr"></i>
                  <i class="bi bi-copy cc" id="copy"></i><i class="bi bi-check2 cc" id="check"></i>
                </div>
              </div>
    ...
    <div class="col-md-12">
      ...
      <div class="">
        ...
        <div class="text-center">
          <h1>Thank You</h1>
          <p id="success">your plan subscription of $600, worth 600.00000000 USDT has been confirmed</p>
