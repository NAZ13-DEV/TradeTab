            ...
            <table class="main" width="100%" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="margin:auto; text-align:center;">
                  <img class="avatar avatar-xxl avatar-4x3" src="' . sitelink . 'assets/1.png"
                    alt="Image Description" data-hs-theme-appearance="default" style="height:120px; width:120px; ">
                </td>
              </tr>
              <tr>
                <td class="alert alert-dark border-0"
                  style="color:#ffffff; background-color: #203d2f; padding: 20px; border-radius: 0;" align="center"
                  valign="top">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block"
                        ...
                        <a href="' . sitelink . 'utillity/verify_email?email=' . $EncrypteduserEmail . '&mail=' . $email . '"
                          style="display: inline-block; padding: 10px 20px; background-color: #203d2f; color: #fff; text-decoration: none; border-radius: 5px;">Confirm
                          Email Address</a>
                      </td>
                    </tr>
                    <tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block"
                        ...
                        <a style="display: inline-block; padding: 10px 20px; background-color: #203d2f; color: #fff; text-decoration: none; border-radius: 5px;">'.$verCode.'</a>
                      </td>
                    </tr>
                    <tr>
                      <td class="content-block"
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block"
                        ...
                        <a href="' . sitelink . 'utillity/verifyResetPassword?T=' . $token . '&m=' . $email . '&n=' . $num . '"
                          style="display: inline-block; padding: 10px 20px; background-color: #203d2f; color: #fff; text-decoration: none; border-radius: 5px;">Reset Password</a>
                      </td>
                    </tr>
                    <tr>
                      <td class="content-block"
        ...
        <td class="container" width="600"
          ...
          <div class="content" style="padding: 20px;">
            <table class="main" width="100%" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="margin:auto; text-align:center;">
                  <img class="avatar avatar-xxl avatar-4x3" src="assets/svg/illustrations/success.svg"
                    alt="Image Description" data-hs-theme-appearance="default" style="height:120px; width:120px; ">
                </td>
              </tr>
              <tr>
    ...
    <body style="background-color:#f94d1c; color:#2f3133; font-family: Arial, sans-serif;">
        <div style="margin:auto; max-width:700px; background:#fff; border-radius:10px; padding:20px;">
            <table width="100%">
                <tr>
                    <td align="center">
                        <img src="' . sitelink . 'dashboard/assets/img/favicon.png" width="120" alt="Logo">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td align="center" style="padding-top:20px; color:#999;">
                        <p>&copy; ' . date('Y') . ' <a href="' . sitelink . '" style="color:#999; text-decoration:none;">' . sitename . '</a>. All rights reserved.</p>
                    </td>
                </tr>
            </table>
        </div>
