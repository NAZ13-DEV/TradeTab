...
function SignupForm() {
  ...
  // Conditional classes for password input field
  const passwordBorderClass = password.length >= 6 ? 'border-Neutral-8' : 'border-Neutral-6';
  const confirmPasswordBorderClass = password === confirmPassword ? 'border-Neutral-8' : 'border-Neutral-6';
        ...
        <div className='form-control w-full'>
          ...
          <div className='relative'>
            <input
              ...
              className={`px-2 py-[10px] rounded bg-Primary-3 text-Neutral-6 border ${confirmPasswordBorderClass} outline-none w-full`}
            />
            <button
              type='button'
